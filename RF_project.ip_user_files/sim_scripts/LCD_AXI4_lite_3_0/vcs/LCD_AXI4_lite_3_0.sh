...
#                script (type 'LCD_AXI4_lite_3_0.sh -help' for more information).
#
...
compile()
{
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../Documents/vivado/2025.1/data/rsb/busdef" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.LCD_AXI4_lite_3_0 xil_defaultlib.glbl -o LCD_AXI4_lite_3_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./LCD_AXI4_lite_3_0_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/mysimp/RF_project/RF_project.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key LCD_AXI4_lite_3_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc LCD_AXI4_lite_3_0_simv.daidir vcs_lib c.obj)
