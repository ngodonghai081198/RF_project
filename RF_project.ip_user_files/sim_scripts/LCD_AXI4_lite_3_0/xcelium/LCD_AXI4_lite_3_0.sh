...
compile()
{
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../Documents/vivado/2025.1/data/rsb/busdef" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.LCD_AXI4_lite_3_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.LCD_AXI4_lite_3_0 -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/mysimp/RF_project/RF_project.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log LCD_AXI4_lite_3_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
