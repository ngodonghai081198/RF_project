...
#
# Script generated by Vivado on Sat Aug 22 11:36:25 +07 2026
# SW Build 6140274 on Wed May 21 22:58:25 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : LCD_AXI4_lite_3_0.sh
...
#
# Usage        : LCD_AXI4_lite_3_0.sh
#                LCD_AXI4_lite_3_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                LCD_AXI4_lite_3_0.sh [-reset_run]
#                LCD_AXI4_lite_3_0.sh [-reset_log]
#                LCD_AXI4_lite_3_0.sh [-help]
#
...
export RDI_DATADIR="/home/mysimp/Documents/vivado/2025.1/data"

# set xvlog options
xvlog_opts="--incr --relax "

# script info
echo -e "LCD_AXI4_lite_3_0.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./LCD_AXI4_lite_3_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot LCD_AXI4_lite_3_0 xil_defaultlib.LCD_AXI4_lite_3_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim LCD_AXI4_lite_3_0 -key {Behavioral:sim_1:Functional:LCD_AXI4_lite_3_0} -tclbatch cmd.tcl -protoinst "protoinst_files/LCD_AXI4_lite_3.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/mysimp/Documents/vivado/2025.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb LCD_AXI4_lite_3_0.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./LCD_AXI4_lite_3_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: LCD_AXI4_lite_3_0.sh [-help]\n\
Usage: LCD_AXI4_lite_3_0.sh [-step]\n\
Usage: LCD_AXI4_lite_3_0.sh [-lib_map_path]\n\
Usage: LCD_AXI4_lite_3_0.sh [-reset_run]\n\
Usage: LCD_AXI4_lite_3_0.sh [-reset_log]\n\
Usage: LCD_AXI4_lite_3_0.sh [-keep_index]\n\
Usage: LCD_AXI4_lite_3_0.sh [-noclean_files]\n\n\
